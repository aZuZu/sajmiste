    ...
    <footer className="mt-20 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="mt-3 text-sm text-gray-500">Moderna hrvatska platforma za kupovinu i prodaju.</p>
        </div>
        <div>
      ...
      <div className="mt-8 text-sm text-gray-400">© {new Date().getFullYear()} Sajmište.hr — Sva prava pridržana.</div>
    </footer>
  )
}
